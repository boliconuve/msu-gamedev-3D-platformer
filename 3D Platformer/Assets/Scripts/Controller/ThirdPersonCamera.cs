...
public class ThirdPersonCamera : MonoBehaviour 
{
    ...
    {
        // Camera input
        float horizontalInput = -horizontalLook; //Cambiando el valor de los inputs para que no se inviertan
        //float verticalInput = -verticalLook; //Cambiando el valor de los inputs para que no se inviertan
    ...
    public float minimumDistance = 5.0f; // public float minimumDistance = 0.8f;
